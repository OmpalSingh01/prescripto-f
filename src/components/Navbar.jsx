          ...
          <div className="flex items-center gap-4">
            {token && userData ? (
              ...
              {/* Desktop Admin Button */}
                <button
                  onClick={() => window.open('https://prescripto-a.vercel.app/', '_blank')}
                  className="flex items-center gap-2 border border-gray-700 text-gray-700 px-2 py-0 rounded-lg font-medium shadow-sm hover:bg-gray-100 hover:text-gray-900 hover:scale-105 transition-all duration-100 hidden md:flex"
                >
      ...
      >
        ...
        <ul className="flex flex-col px-3 mt-4 gap-1 text-base font-medium">
          ...
          {!token && (
            ...
            {/* Mobile Admin Button */}
              <button
                onClick={() => { setShowMenu(false); window.open('https://prescripto-a.vercel.app/', '_blank') }}
                className="flex items-center gap-2 w-full text-left border border-gray-300 text-gray-700 px-3 py-1 rounded-lg font-medium shadow-sm hover:bg-gray-100 hover:text-gray-900 hover:scale-105 transition-all duration-300"
              >
                <KeyIcon className="w-4 h-4" />
                Admin
              </button>
